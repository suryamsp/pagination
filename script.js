...
for(i=1;i<6;i++){
    var tak_for=document.querySelector(`.btn-${i}`)
    var atr_val=parseInt(tak_for.getAttribute('for'))
    var inc_atr_val= atr_val + 5
    tak_for.setAttribute('for',inc_atr_val)
    tak_for.innerText=inc_atr_val
}
